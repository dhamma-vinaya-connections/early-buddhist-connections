...
1. The Buddha’s basic approach in this discourse is to take a line of questioning that he usually applies to the five aggregates (see []) and to apply it to the framework of the six sense media as given in []. This phrase, however, is the one point where this sutta deviates from that framework. The corresponding phrase in [] focuses exclusively on feelings. The passage here—_vedanāgataṁ, saññāgataṁ, saṅkhārāgataṁ, viññāṇagataṁ_—focuses on all four mental aggregates. For another example of translating _–gataṁ_ as “mode,” see the phrase “mode of perception” _(saññāgataṁ)_ in []. For another example of a teaching that combines the two frameworks of five aggregates and six sense media, see [].
