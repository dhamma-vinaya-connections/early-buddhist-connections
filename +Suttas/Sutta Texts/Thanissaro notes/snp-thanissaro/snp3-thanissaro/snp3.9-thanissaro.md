...
SnA and DhpA, however, try to make more of the image by exploring the interconnections of the chariot parts. In their explanation, cord = 62 wrong views (listed in the _Brahmajāla Sutta,_ [[+Suttas/Sutta Texts/Thanissaro/Thanissaro notes/dn-thanissaro/dn1-thanissaro]]) and bridle = obsessions (sensuality, becoming, anger, conceit, views, uncertainty, ignorance ([[an7.11-thanissaro]]-12)). They note the connection between the 62 wrong views and the obsessions (one of which is views), which is apparently similar to the way the cord and bridle are connected. They go on to note that when one has cut all these things, the bar, which equals ignorance, has been lifted. The fact that the cutting of these chariot parts automatically accomplishes the lifting of the bar is apparently symbolic of the fact that ignorance is one of the obsessions.
