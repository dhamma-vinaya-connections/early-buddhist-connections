...
*Bu-Pc.58.2.1* New means: it is called so if not made allowable.[^11]

Robe means: any one robe of the six (kinds of) robes.[^12]
...
Dark green[^13] means: there are two (kinds of) dark *BD.2.408* green: the dark green of bronze,[^14] the dark green of foliage.[^15]

Mud(-colour)[^16] means: it is called water.[^17]
...
*Bu-Pc.58.2.2* If he makes use of it, thinking that he has not taken[^21] when he has not taken, there is an offence of expiation. If he is in doubt as to whether he has not taken … If he makes use of it, thinking that he has taken when he has not taken, there is an offence of expiation. If he thinks that he has not taken when he has taken, there is an offence of wrong-doing. If he is in doubt as to whether he has taken, there is an offence of wrong-doing. If he thinks that he has taken when he has taken, there is no offence.

* * *

*Bu-Pc.58.2.3* *BD.2.409* There is no offence if, having taken, he makes use of it; if what is allowable becomes destroyed[^22]; if what made the appearance allowable becomes worn away[^23]; if what was not made allowable[^24] becomes sewn together[^25] with what was made allowable[^26]; if there is a patch[^27]; if there is a braiding[^28]; if there is a binding *BD.2.410* [^29]; if he is mad, if he is the first wrong-doer.
