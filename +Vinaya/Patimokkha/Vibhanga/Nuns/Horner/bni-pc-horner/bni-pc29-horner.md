---
vin_code: "BNI-PC29"
vin_title: "Kālaatikkamana - Letting the Time Expire"
...
*Bi-Pc.29.2.1* *BD.3.301* Whatever means: … nun is to be understood in this case.
...
Robe-season means: the last month of the rainy season when the _kaṭhina_ cloth is not (formally) made, *Vin.4.287* the five months when it is (formally) made.[^3]

Should let the robe-season pass means: if she lets pass the last day of the rainy season when the _kaṭhina_ cloth is not (formally) made, there is an offence of expiation. If she lets the day pass for removing the _kaṭhina_ (privileges),[^4] there is an offence of expiation.

* * *

*Bi-Pc.29.2.2* If she thinks that the robe-material is not sure when it is not sure (and) lets the robe-season pass, there is an offence of expiation. If she is in doubt as to whether the robe-material is not sure … offence of wrong-doing. If she thinks that the robe-material is sure[^5] when it is not sure … no offence. If she thinks that the robe-material is not sure when it is sure, there is an offence of wrong-doing. If she is in doubt as to whether the robe-material is sure, there is an offence of wrong-doing. If she thinks that the robe-material is sure when it is sure, there is no offence.

* * *

*Bi-Pc.29.2.3* There is no offence if she hinders having pointed out an advantage[^6]; if she is mad, if she is the first wrong-doer.
...
> Click for all [available texts and translations ](obsidian://search?query=file:bni-pc29-)
> 
