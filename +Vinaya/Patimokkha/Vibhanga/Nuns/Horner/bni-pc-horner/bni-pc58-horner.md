...
language: "English"
---
> [!important] ☸️ [[ebt-source/Static just copy/Patimokkha.base#patimokkha-catalogue|Vin Catalogue]] I 📒 [[BNI]] / 📂 [[BNI-PC]] I 🌐 [[BNI-PC58]]
> ◄  [[bni-pc57-horner]] 📜  [[bni-pc59-horner]] ►
...
*Bi-Pc.58.2.1* Whatever means: … nun is to be understood in this case.

Exhortation means: the eight important rules.[^3]

Communion means: one (formal) act, one recitation, an equal training.[^4] If she thinks, “I will not go for *BD.3.357* exhortation or for communion,” in throwing off the responsibility, there is an offence of expiation.

* * *

*Bi-Pc.58.2.2* There is no offence if there is an obstacle; if, having looked about for a nun as a companion, she does not get the chance; if she is ill; if there are accidents; if she is mad, if she is the first wrong-doer.[^5]
