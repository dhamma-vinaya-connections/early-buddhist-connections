---
vin_code: "BNI-PC26"
vin_title: "Gaṇacīvara - Group Robes"
...
*BD.3.295* A group means: it is called an Order of nuns.[^4]

Robe means: any one robe of the six (kinds of) robes (including) the least one fit for assignment.[^5] *Vin.4.284*

Should put an obstacle in the way means: if, saying: “How can this robe be given?” she puts an obstacle in the way, there is an offence of expiation. If she puts an obstacle in the way of another requisite, there is an offence of wrong-doing. If she puts an obstacle in the way of a robe or of another requisite for several nuns[^6] or for one nun or for a woman who is not ordained, there is an offence of wrong-doing.

* * *

*Bi-Pc.26.2.2* There is no offence if she hinders having pointed out an advantage[^7]; if she is mad, if she is the first wrong-doer.
...
> Click for all [available texts and translations ](obsidian://search?query=file:bni-pc26-)
> 
