...
[suttacentral.net/kn7](https://suttacentral.net/pli-tv-kd7/en/brahmali?lang=en&layout=plain&reference=none&notes=asterisk&highlight=false&script=latin)

#### 1. The allowance for a robe-making ceremony ^1

> [!TIP]- Links to [[mv7-deepseek-pali#^1|Deep Seek Version]] and BMC2 
...
#### 2. The group of seven on “takes” ^2

> [!TIP]- Links to [[mv7-deepseek-pali#^2|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 3. The group of seven on “with” ^3

> [!TIP]- Links to [[mv7-deepseek-pali#^3|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 4. The group of six on “takes” ^4

> [!TIP]- Links to [[mv7-deepseek-pali#^4|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 5. The group of six on “with” ^5

> [!TIP]- Links to [[mv7-deepseek-pali#^5|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 6. The group of fifteen on “takes” ^6

> [!TIP]- Links to [[mv7-deepseek-pali#^6|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 7. The group of fifteen on “with”, etc. ^7

> [!TIP]- Links to [[mv7-deepseek-pali#^7|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
60(To be expanded in detail as in the section on “takes”, [Pli Tv Kd 7:6.1.2 6.4.23](/pli-tv-kd7#6.1.2--6.4.23).)
...
62(To be expanded in detail as in the section on “with”, [Pli Tv Kd 7:7.1.1 Pli Tv Kd 7:7.1.2](/pli-tv-kd7#7.1.1--pli-tv-kd7:7.1.2) = [Pli Tv Kd 7:6.1.1 6.4.23](/pli-tv-kd7#6.1.1--6.4.23).)

#### 8. The group of fifteen on “with an unfinished” ^8

> [!TIP]- Links to [[mv7-deepseek-pali#^8|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 9. The group of twelve on “not as expected” ^9

> [!TIP]- Links to [[mv7-deepseek-pali#^9|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 10. The group of twelve on “as expected” ^10

> [!TIP]- Links to [[mv7-deepseek-pali#^10|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 11. The group of twelve on business ^11

> [!TIP]- Links to [[mv7-deepseek-pali#^11|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 12. The group of nine on “without taking” ^12

> [!TIP]- Links to [[mv7-deepseek-pali#^12|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 13. The group of five on “meditation going well” ^13

> [!TIP]- Links to [[mv7-deepseek-pali#^13|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
#### 14. Discussion on obstacles and removal of obstacles ^14

> [!TIP]- Links to [[mv7-deepseek-pali#^14|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
## Pali
#### 1. Kathinānujānana ^15

> [!TIP]- Links to [[mv7-deepseek-pali#^15|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
...
> [!TIP]- Links to [[mv7-deepseek-pali#^16|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.16" file:bmc2 -queryblock
> ```
...
#### 3. Samādāyasattaka ^17

> [!TIP]- Links to [[mv7-deepseek-pali#^17|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.17" file:bmc2 -queryblock
> ```
...
> [!TIP]- Links to [[mv7-deepseek-pali#^18|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.18" file:bmc2 -queryblock
> ```
...
> [!TIP]- Links to [[mv7-deepseek-pali#^19|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.19" file:bmc2 -queryblock
> ```
...
#### 6. Ādāyapannarasaka ^20

> [!TIP]- Links to [[mv7-deepseek-pali#^20|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.20" file:bmc2 -queryblock
> ```
...
#### 7. Samādāyapannarasakādi ^21

> [!TIP]- Links to [[mv7-deepseek-pali#^21|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.21" file:bmc2 -queryblock
> ```
...
#### 8. Vippakatasamādāyapannarasaka ^22

> [!TIP]- Links to [[mv7-deepseek-pali#^22|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.22" file:bmc2 -queryblock
> ```
...
> [!TIP]- Links to [[mv7-deepseek-pali#^23|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.23" file:bmc2 -queryblock
> ```
...
> [!TIP]- Links to [[mv7-deepseek-pali#^24|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.24" file:bmc2 -queryblock
> ```
...
#### 11. Karaṇīyadoḷasaka ^25

> [!TIP]- Links to [[mv7-deepseek-pali#^25|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.25" file:bmc2 -queryblock
> ```
...
#### 12. Apavilāyananavaka ^26

> [!TIP]- Links to [[mv7-deepseek-pali#^26|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.26" file:bmc2 -queryblock
> ```
...
#### 13. Phāsuvihārapañcaka ^27

> [!TIP]- Links to [[mv7-deepseek-pali#^27|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.27" file:bmc2 -queryblock
> ```
...
#### 14. Palibodhāpalibodhakathā ^28

> [!TIP]- Links to [[mv7-deepseek-pali#^28|Deep Seek Version]] and BMC2 
> [[bmc2#^ch17|BMC Chapter 17]] and the following cites:
>  
> ```query
> "VIN-MV7.28" file:bmc2 -queryblock
> ```
...
[[+Vinaya/Khandaka/Brahmali/mv-brahmali-pali/mv6-brahmali-pali#content]][[+Vinaya/Khandaka/Brahmali/mv-brahmali-pali/mv8-brahmali-pali#content]]
